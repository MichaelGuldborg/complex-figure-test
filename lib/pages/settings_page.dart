      ...
      body: GridView.count(
        ...
        children: [
          ...
          GridItemToggle(
            ...
            title: 'Split screen',
            subtitle:
                'Show the reference image during the "copy" stage of the test in split screen mode',
            value: settings.splitScreen,
            onChange: (v) => settings.update(splitScreen: v),
          ),
          GridItemToggle(
            icon: Icons.image,
            title: 'Image preview',
            subtitle: 'Allow user to view the reference image in fullscreen during the "copy" stage of the test',
            value: settings.imagePreview,
            onChange: (v) => settings.update(imagePreview: v),
          ),
          // GridItemToggle(
          ...
          //   subtitle: 'Allow user to view the reference image in fullscreen during the "copy" stage of the test',
          //   value: settings.imagePreview,
          //   onChange: (v) => provider.update(preview: v),
          // ),
          GridItemToggle(
